...
StatusProgressBar::StatusProgressBar(wxWindow* parent/*, wxWindowID id, long style, const wxString& name*/ ) : wxStatusBar(parent,-1,wxST_SIZEGRIP )//,style/*|wxNO_FULL_REPAINT_ON_RESIZE|wxCLIP_CHILDREN*/,name)
{
